...
实现或修改 Core Framework 时，必须在交付说明中包含挂载表，并同步更新 `docs/version_02/core_framework_scene_setup.md`。
...
详细 Hierarchy、Inspector 字段与验证步骤见 **`docs/version_02/core_framework_scene_setup.md`**。每个新增类须在源码中添加 `///` 类注释，写明是否挂载、推荐物体名、获取方式。
