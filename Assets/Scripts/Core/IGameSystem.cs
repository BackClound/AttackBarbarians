...
/// <para><b>实现者：</b><see cref="ConfigManager"/>、<see cref="SaveManager"/>、<see cref="PoolManager"/>、<see cref="GameManager"/>、<see cref="GameFlowManager"/>、<see cref="AudioManager"/>、<see cref="EventBus"/>。</para>
